...
1. Desnaturalização: Questione o que está sendo tratado como "natural", inevitável ou neutro, evidenciando como essas condições são construídas e sustentadas.
2. Hibridismo: Explore como humanos e tecnologias se constituem mutuamente, formando arranjos híbridos nos quais fronteiras não são fixas, mas continuamente negociadas.
3. Coexistência e interdependência: Considere que diferentes agentes — humanos e não humanos — coexistem e dependem uns dos outros, influenciando-se de maneiras nem sempre visíveis.
4. Conhecimento situado: Reflita sobre de quais posições, contextos e experiências as decisões emergem, e quem pode estar sendo silenciado, excluído ou privilegiado.
5. Imaginação política: Explore como a solução pode reforçar ou transformar realidades existentes, abrindo ou restringindo possibilidades de futuro e formas de viver.
6. Materialidade do poder: Identifique como o poder se manifesta de forma concreta nas regras, interfaces, fluxos e estruturas do sistema, moldando comportamentos e decisões.
